...
<title><?php echo $traductor->traducir('config_digital_titulo'); ?> - Draftosaurus - NoxByte</title>
...
<main class="main-configuracion flex-grow-1">
    <div id="seccion-bienvenida">
        <div class="panel-configuracion">
            <h2><?php echo $traductor->traducir('config_digital_bienvenida_titulo'); ?></h2>
            <p>
                <?php echo $traductor->traducir('config_digital_bienvenida_texto'); ?>
            </p>
